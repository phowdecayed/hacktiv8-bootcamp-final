...
<template>
  <LegalLayout title="Terms of Service" lastUpdated="July 10, 2025">
    ...
    <p>
      ...
      responsible for safeguarding your account information and for all activities that occur under
    ...
    <p>
      In no event shall MINIMALIST, nor its directors, employees, partners, agents, suppliers, or
